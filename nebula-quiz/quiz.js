(() => {
  "use strict";
  const config = {"palette":{"ink":"#32210e","muted":"#77644c","surface":"#fffaf0","accent":"#d07b19","accent_text":"#241507"},"eyebrow":"Follow what feels important","title":"Choose your guidance path","intro":"A brief check-in helps you start with intention.","result_title":"Your path is open","result":"Continue to discover the insight that matches your moment.","questions":[{"text":"What feels most important now?","choices":["Love","Opportunity","Inner clarity"]},{"text":"What kind of answer do you seek?","choices":["What may happen","What to do","What I may be missing"]}]};
